...
GeoLocator.prototype.updatePosition=function(a){this.lastData={lat:a.coords.latitude,lng:a.coords.longitude};console.log(this.lastData);this.mainLocationMarker?(this.mainLocationMarker.setPosition(this.lastData),null===this.geoId&&(a=this.app.getClosestTrailStart(a.coords.latitude,a.coords.longitude),this.app.showInfo("Posisjon oppdatert<hr>N\u00e6rmeste sti: <b>"+a.getTitle()+"</b><br>Din posisjon oppdateres ogs\u00e5 automatisk",6))):(a=this.app.getClosestTrailStart(a.coords.latitude,a.coords.longitude),
this.app.showInfo("Posisjon funnet<hr>N\u00e6rmeste sti: <b>"+a.getTitle()+"</b><br>Din posisjon vil etter dette oppdateres automatisk",6),this.mainLocationMarker=new google.maps.Marker({position:this.lastData,map:this.app.getMainMap(),icon:{path:google.maps.SymbolPath.CIRCLE,scale:6,strokeColor:"#F00"}}));this.trailLocationMarker?this.trailLocationMarker.setPosition(this.lastData):this.trailLocationMarker=new google.maps.Marker({position:this.lastData,map:this.app.getTrailMap(),icon:{path:google.maps.SymbolPath.CIRCLE,
scale:6,strokeColor:"#F00"}});null===this.geoId&&(this.geoId=navigator.geolocation.watchPosition(this.updatePosition.bind(this)),this.app.getMainMap().setCenter(this.lastData))};var MtbMapApplication=function(a){this.config=a;this.infoTimeout=this.trailMap=this.mainMap=null;this.trails=[];this.currDetailTrail=null;this.show3d=!1;this.mainBounds=null;this.geoLocator=new GeoLocator(this);this.updateStaticText();$("#closetrailinfo").click(this.closeTrailInfo.bind(this));$("#trail3dBtn").click(this.showTrail3d.bind(this));$("#trail2dBtn").click(this.showTrail2d.bind(this))};
MtbMapApplication.prototype.updateStaticText=function(){$("#infotextcontent").html(this.config.main.infoText+'<h2>mtbmaps.net</h2>M\u00e5let med mtbmaps.net er \u00e5 tilby en lettvekts webapplikasjon for navigasjon i typiske norske stinettverk som best\u00e5r av flere sm\u00e5 segmenter i motsetning til lange sammenhengende l\u00f8yper. Det er fokus p\u00e5 \u00e5 kunne finne inngangen p\u00e5 stiene.<br>L\u00f8sningen skal v\u00e6re enkel \u00e5 sette opp og krever ingen dynamisk serviersideteknologi.<br>Du kan forke prosjektet p\u00e5 <a href="https://github.com/cynodia/ast-maps">GitHub</a>.<br>'+
...
MtbMapApplication.prototype.closeTrailInfo=function(){this.currDetailTrail.renderTo(this.mainMap,this.onMapElemClicked.bind(this));this.currDetailTrail=null;$("#trailwindow").fadeOut(500)};MtbMapApplication.prototype.hideInfo=function(){null!=this.infoTimeout&&clearTimeout(this.infoTimeout);$("#infopopup").fadeOut(500)};
MtbMapApplication.prototype.showInfo=function(a,b){b||(b=4);$("#infopopup").html(a);$("#infopopup").fadeIn(500);this.infoTimeout=setTimeout(function(){$("#infopopup").fadeOut(500);this.infoTimeout=null}.bind(this),1E3*b)};
MtbMapApplication.prototype.initMap=function(){console.log("Setting up maps...");this.mainBounds=new google.maps.LatLngBounds;this.mainMap=new google.maps.Map(document.getElementById("map"),{mapTypeId:"hybrid",mapTypeControl:!1,disableDefaultUI:!0});this.trailMap=new google.maps.Map(document.getElementById("trailmap"),{mapTypeId:"hybrid",mapTypeControl:!1,disableDefaultUI:!0});for(var a in this.config.markers)this.config.markers.hasOwnProperty(a)&&(new google.maps.Marker({position:this.config.markers[a].position,
map:this.mainMap,title:this.config.markers[a].title,icon:this.config.markers[a].icon}),this.mainBounds.extend(new google.maps.LatLng(this.config.markers[a].position.lat,this.config.markers[a].position.lng)));var b=this.config.trails.length;for(a=0;a<this.config.trails.length;a++){var c=new Trail(this.config.trails[a],this.config.main.levelColors);c.loadTrail(function(a){a.renderTo(this.mainMap,this.onMapElemClicked.bind(this));this.mainBounds.union(a.getBounds());b--;0===b&&(console.log("DONE - fit map..."),
this.mainMap.fitBounds(this.mainBounds,0))}.bind(this));this.trails.push(c);console.log("Added trail "+c.getTitle())}this.addHelpOverlays();this.hideInfo()};MtbMapApplication.prototype.getClosestTrailStart=function(a,b){for(var c=this.trails[0].distanceToStart(a,b),e=this.trails[0],d=1;d<this.trails.length;d++){var f=this.trails[d].distanceToStart(a,b);f<c&&(c=f,e=this.trails[d])}return e};MtbMapApplication.prototype.resetMainMap=function(){this.mainMap.fitBounds(this.mainBounds,0)};
...
Trail.prototype.loadTrail=function(a){var b=this;this.bounds=new google.maps.LatLngBounds;$.ajax({type:"GET",url:this.config.url,cache:!1,dataType:"xml",success:function(c){var e=null,d=null,f=null,h=null;$(c).find("gpx").each(function(){$(this).find("trk").each(function(){$(this).find("trkseg").each(function(){$(this).find("trkpt").each(function(){var a=parseFloat($(this).attr("lat")),c=parseFloat($(this).attr("lon"));b.coordinates.push({lat:a,lng:c});b.distances.push(null===f?0:b.calcCrow(f,h,a,
c));b.bounds.extend(new google.maps.LatLng(a,c));f=a;h=c;var g=0;$(this).find("ele").each(function(){g=parseFloat($(this).text());null===e?e=d=g:e>g?e=g:d<g&&(d=g)});b.altitudes.push(g)})})})});b.heightDiff=d-e;a(b)}})};Trail.prototype.distanceToStart=function(a,b){return this.calcCrow(a,b,this.coordinates[0].lat,this.coordinates[0].lng)};Trail.prototype.patchClicked=function(){this.clickCb&&this.clickCb(this)};
