...
'<i style="cursor:pointer; font-size: 34px;" class="fa fa-toggle-on"></i>',this.toggleButton.onclick=this.toggleBackground.bind(this),a.appendChild(this.toggleButton));b=document.createElement("button");b.style.background="rgba(255,255,255,.6)";b.style.padding="12px";b.setAttribute("class","topButton");b.style.fontSize="16px";b.style.cursor="pointer";b.innerHTML='<i style="cursor:pointer; font-size: 34px;" class="fa fa-home"></i>';b.onclick=this.resetMainMap.bind(this);a.appendChild(b);this.mainMap.controls[google.maps.ControlPosition.TOP_RIGHT].push(a)};
MtbMapApplication.prototype.toggleBackground=function(a){this.mapBg.setMap(this.mapBgActive?null:this.mainMap);this.mapBgActive=!this.mapBgActive;this.toggleButton.innerHTML=this.mapBgActive?'<i style="cursor:pointer; font-size: 34px;" class="fa fa-toggle-on"></i>':'<i style="cursor:pointer; font-size: 34px;" class="fa fa-toggle-off"></i>'};
