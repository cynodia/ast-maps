...
MtbMapApplication.prototype.addHelpOverlays=function(){var a=document.createElement("div");a.style.background="rgba(255,255,255,.6)";a.style.padding="6px";a.style.fontSize="16px";a.index=1;a.innerHTML="<i style='font-weight:bold; color: "+this.config.main.levelColors[1]+";' class=\"fa fa-minus\"></i> Lett<br><i style='font-weight:bold; color: "+this.config.main.levelColors[2]+";' class=\"fa fa-minus\"></i> Middels<br><i style='font-weight:bold; color: "+this.config.main.levelColors[3]+';\' class="fa fa-minus"></i> Vanskelig<hr><i style=\'color: #ffffff;\' class="fa fa-circle"></i> Start';
mobilecheck()&&(a.innerHTML+="<br><i style='color: #f00;' class='fa fa-circle'></i> Deg");this.mainMap.controls[google.maps.ControlPosition.TOP_LEFT].push(a);a=document.createElement("button");a.style.background="rgba(255,255,255,.6)";a.style.padding="12px";a.style.fontSize="16px";a.style.cursor="pointer";a.index=1;a.innerHTML='<i style="cursor:pointer; font-size: 34px;" class="fa fa-home"></i>';a.onclick=this.resetMainMap.bind(this);this.mainMap.controls[google.maps.ControlPosition.TOP_RIGHT].push(a);
mobilecheck()&&(a=document.createElement("button"),a.style.background="rgba(255,255,255,.6)",a.style.padding="12px",a.style.marginRight="10px",a.style.fontSize="16px",a.style.cursor="pointer",a.index=2,a.innerHTML='<i style="cursor:pointer; font-size: 34px;" class="fa fa-crosshairs"></i>',a.onclick=function(){this.geoLocator.mapUserLocation()}.bind(this),this.mainMap.controls[google.maps.ControlPosition.TOP_RIGHT].push(a),a=document.createElement("button"),a.style.background="rgba(255,255,255,.6)",
a.style.padding="12px",a.style.marginRight="10px",a.style.fontSize="16px",a.style.cursor="pointer",a.index=2,a.innerHTML='<i style="cursor:pointer; font-size: 34px;" class="fa fa-info-circle"></i>',a.onclick=function(){$("#infotext").fadeIn(750,function(){$("html, body").animate({scrollTop:0},"slow")})},this.mainMap.controls[google.maps.ControlPosition.TOP_RIGHT].push(a))};
MtbMapApplication.prototype.onMapElemClicked=function(a){this.currDetailTrail=a;$("html, body").animate({scrollTop:0},"slow");$("#trailinfoheader").html(a.getTitle());$("#chart3d").empty();$("#elevationchart").empty();for(var b=0,f=new vis.DataSet,c=a.getCoords(),d=a.getAltitudes(),e=0;e<c.length;e++)f.add({id:b++,x:c[e].lng,y:c[e].lat,z:d[e],style:50});b={width:"100%",height:"100%",style:"bar-size",showPerspective:!0,showGrid:!1,showShadow:!1,keepAspectRatio:!0,verticalRatio:10>a.getHeightDiff()?
.1:.2,xBarWidth:3E-4,yBarWidth:3E-4,xLabel:"",yLabel:"",zLabel:"moh",xValueLabel:function(a){return""},yValueLabel:function(a){return""}};this.trailMap.setCenter(new google.maps.LatLng(c[0].lat,c[0].lng));a.renderTo(this.trailMap);c='<img class="shadowed" width="100%" align="center" src="data/pics/start.jpg"/><br>'+a.getFindStartText();$("#trailentrance").html(c);$("#trailinfotext").html(a.getInfoText());$("#trailfacts").html('<p style="margin: 0; text-align:left;">Lengde: '+Math.floor(1E4*a.getLength())/
10+'m<span style="float:right;">'+(mobilecheck()?"H\u00f8ydefor.":"H\u00f8ydeforskjell")+": "+Math.floor(10*a.getHeightDiff())/10+"m</span></p>Vanskelighetsgrad: "+a.getLevelAsText());$("#trailwindow").fadeIn(750);new vis.Graph3d(document.getElementById("chart3d"),f,b)};var Trail=function(a,b){this.config=a;this.heightDiff=0;this.coordinates=[];this.altitudes=[];this.clickCb=this.path=this.stopMarker=this.startMarker=null;this.levelColors=b};Trail.prototype.getInfoText=function(){return this.config.infoText};Trail.prototype.getFindStartText=function(){return this.config.findStartText};Trail.prototype.getLevel=function(){return this.config.level};Trail.prototype.getTitle=function(){return this.config.title};Trail.prototype.getHeightDiff=function(){return this.heightDiff};
Trail.prototype.getCoords=function(){return this.coordinates};Trail.prototype.getAltitudes=function(){return this.altitudes};Trail.prototype.getLength=function(){return this.path?this.path.inKm():0};Trail.prototype.getTrailColor=function(){if(this.levelColors.hasOwnProperty(this.config.level))return this.levelColors[this.config.level]};Trail.prototype.getLevelAsText=function(){switch(this.config.level){case 2:return"Middles";case 3:return"H\u00f8y";default:return"Lav"}};
Trail.prototype.loadTrail=function(a){var b=this;$.ajax({type:"GET",url:this.config.url,cache:!1,dataType:"xml",success:function(f){var c=null,d=null;$(f).find("gpx").each(function(){$(this).find("trk").each(function(){$(this).find("trkseg").each(function(){$(this).find("trkpt").each(function(){b.coordinates.push({lat:parseFloat($(this).attr("lat")),lng:parseFloat($(this).attr("lon"))});var a=0;$(this).find("ele").each(function(){a=parseFloat($(this).text());null===c?c=d=a:c>a?c=a:d<a&&(d=a)});b.altitudes.push(a)})})})});
b.heightDiff=d-c;a(b)}})};Trail.prototype.patchClicked=function(){this.clickCb&&this.clickCb(this)};
