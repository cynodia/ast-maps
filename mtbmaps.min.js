...
(mobilecheck()?"Du ser n\u00e5 p\u00e5 mobilutgaven av webapplikasjonen.":'Du ser n\u00e5 p\u00e5 desktoputgaven av webapplikasjonen. <a href="index_mobile.html">Mobilversjon</a>'));mobilecheck()||$("#headertext").html(mobilecheck()?this.config.main.mainHeaderMobile:this.config.main.mainHeaderDesktop)};MtbMapApplication.prototype.infoPopupClicked=function(){if(this.closestTrail)this.onMapElemClicked(this.closestTrail)};MtbMapApplication.prototype.setClosestTrail=function(a){this.closestTrail=a};
MtbMapApplication.prototype.getMainMap=function(){return this.mainMap};MtbMapApplication.prototype.getTrailMap=function(){return this.trailMap};MtbMapApplication.prototype.closeTrailInfo=function(){this.currDetailTrail.renderTo(this.mainMap,this.onMapElemClicked.bind(this));this.currDetailTrail=null;$("#trailwindow").fadeOut(500)};MtbMapApplication.prototype.hideInfo=function(){null!=this.infoTimeout&&clearTimeout(this.infoTimeout);$("#infopopup").fadeOut(500)};
MtbMapApplication.prototype.showInfo=function(a,b){b||(b=4);null!=this.infoTimeout&&clearTimeout(this.infoTimeout);$("#infopopup").html(a);$("#infopopup").fadeIn(500);this.infoTimeout=setTimeout(function(){$("#infopopup").fadeOut(500);this.infoTimeout=null}.bind(this),1E3*b)};
