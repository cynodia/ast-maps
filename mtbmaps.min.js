...
MtbMapApplication.prototype.calcCrow=function(a,b,d,e){var c=(d-a)*Math.PI/180;b=(e-b)*Math.PI/180;a=a*Math.PI/180;d=d*Math.PI/180;a=Math.sin(c/2)*Math.sin(c/2)+Math.sin(b/2)*Math.sin(b/2)*Math.cos(a)*Math.cos(d);return 12742E3*Math.atan2(Math.sqrt(a),Math.sqrt(1-a))};
MtbMapApplication.prototype.generateGraph3d=function(a){for(var b=new vis.DataSet,d=a.getCoords(),e=a.getAltitudes(),c=0,f=0;f<d.length;f++)b.add({id:c++,x:d[f].lng,y:d[f].lat,z:e[f],style:50});a={width:"100%",height:"100%",style:"bar-size",showPerspective:!0,showGrid:!1,showShadow:!1,keepAspectRatio:!0,verticalRatio:10>a.getHeightDiff()?.1:.2,xBarWidth:3E-4,yBarWidth:3E-4,xLabel:"",yLabel:"",zLabel:"moh",xValueLabel:function(a){return""},yValueLabel:function(a){return""}};new vis.Graph3d(document.getElementById("trailchart"),
b,a)};MtbMapApplication.prototype.generateGraph2d=function(a){var b=new vis.DataSet,d=a.getAltitudes();a=a.getCoords();for(var e=0,c=0;c<d.length;c++)e+=0===c?0:this.calcCrow(a[c-1].lat,a[c-1].lng,a[c].lat,a[c].lng),b.add({x:e,y:d[c]});new vis.Graph2d(document.getElementById("trailchart"),b,{width:"100%",height:"100%",moveable:!1,zoomable:!1,drawPoints:!1,style:"bar",showMajorLabels:!1})};
MtbMapApplication.prototype.showTrail3d=function(){this.show3d=!0;$("#trail3dBtn").hide();$("#trail2dBtn").show();this.currDetailTrail&&($("#trailchart").empty(),this.generateGraph3d(this.currDetailTrail))};MtbMapApplication.prototype.showTrail2d=function(){this.show3d=!1;$("#trail3dBtn").show();$("#trail2dBtn").hide();this.currDetailTrail&&($("#trailchart").empty(),this.generateGraph2d(this.currDetailTrail))};
...
Trail.prototype.loadTrail=function(a){var b=this;$.ajax({type:"GET",url:this.config.url,cache:!1,dataType:"xml",success:function(d){var e=null,c=null;$(d).find("gpx").each(function(){$(this).find("trk").each(function(){$(this).find("trkseg").each(function(){$(this).find("trkpt").each(function(){b.coordinates.push({lat:parseFloat($(this).attr("lat")),lng:parseFloat($(this).attr("lon"))});var a=0;$(this).find("ele").each(function(){a=parseFloat($(this).text());null===e?e=c=a:e>a?e=a:c<a&&(c=a)});b.altitudes.push(a)})})})});
b.heightDiff=c-e;a(b)}})};Trail.prototype.patchClicked=function(){this.clickCb&&this.clickCb(this)};
