...
this.mainMap.fitBounds(this.mainBounds,0))}.bind(this));this.trails.push(c);console.log("Added trail "+c.getTitle())}this.addHelpOverlays();this.hideInfo()};MtbMapApplication.prototype.resetMainMap=function(){this.mainMap.fitBounds(this.mainBounds,0)};
